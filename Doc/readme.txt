"Прибор контроля VLeshka-GSM" представляет собой последовательно подключаемое к нагрузке (переменное напряжение 220В 15А) реле, имеющее LCD-дисплей и 4 кнопки навигации по нему.
